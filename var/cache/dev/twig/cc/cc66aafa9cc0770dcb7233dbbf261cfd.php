...
class __TwigTemplate_4d34005da6733107399073f63166c140 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    <div ";
        // line 12
        echo $this->extensions['Symfony\UX\Vue\Twig\VueComponentExtension']->renderVueComponent("Hello", ["name" => (isset($context["username"]) || array_key_exists("username", $context) ? $context["username"] : (function () { throw new RuntimeError('Variable "username" does not exist.', 12, $this->source); })())]);
        echo "></div>
    <div ";
        // line 13
        echo $this->extensions['Symfony\UX\Vue\Twig\VueComponentExtension']->renderVueComponent("Welcome");
        echo "></div>
</div>
";
...
<div class=\"example-wrapper\">
    ...
    <div {{ vue_component('Welcome') }}></div>
</div>
{% endblock %}
", "default\\index.html.twig", "/var/www/estiam-front/templates/default/index.html.twig");
    }
}
