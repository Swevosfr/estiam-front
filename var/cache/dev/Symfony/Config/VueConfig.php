 ...
 */
class VueConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    /**
     * The path to the directory where Vue controller components are stored - relevant only when using symfony/asset-mapper.
     * @default '%kernel.project_dir%/assets/vue/controllers'
